...
load('matrices_1-9M.mat');
disp('matrix loaded');
% [f,Q,maxM]=convert_to_full_instances(f_ini,Q_ini);
[f,Q,maxM]=convert_to_full_instances(Fmatrix9M,Qmatrix9M);
...
% A priory probs calculated from GATK
p = [0.3075, 0.1892, 0.1915, 0.3099, 0.0001456, 0.00066873, 0.0001105, 0.00019414, 0.00073074, 0.0001483];
